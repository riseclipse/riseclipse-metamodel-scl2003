...
public class VariableImpl extends BaseExtensionElementWithDescImpl implements Variable {
    ...
    public void unsetOriginUuid() {
        ...
        if( eNotificationRequired() ) {
            eNotify( new ENotificationImpl( this, Notification.UNSET, AsdPackage.VARIABLE__ORIGIN_UUID, oldOriginUuid,
                    ORIGIN_UUID_EDEFAULT, oldOriginUuidESet ) );
        }
    }
    ...
    public void unsetTemplateUuid() {
        ...
        if( eNotificationRequired() ) {
            eNotify( new ENotificationImpl( this, Notification.UNSET, AsdPackage.VARIABLE__TEMPLATE_UUID,
    ...
    public void unsetUuid() {
        ...
        uuidESet = false;
        if( eNotificationRequired() ) {
            eNotify( new ENotificationImpl( this, Notification.UNSET, AsdPackage.VARIABLE__UUID, oldUuid, UUID_EDEFAULT,
                    oldUuidESet ) );
        }
    }
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == AgUuid.class ) {
            ...
            case SclPackage.AG_UUID__UUID:
                return AsdPackage.VARIABLE__UUID;
            case SclPackage.AG_UUID__TEMPLATE_UUID:
                return AsdPackage.VARIABLE__TEMPLATE_UUID;
            default:
                return -1;
            }
        }
        if( baseClass == AgUuidWithOrigin.class ) {
            ...
            case AsdPackage.AG_UUID_WITH_ORIGIN__ORIGIN_UUID:
                return AsdPackage.VARIABLE__ORIGIN_UUID;
            default:
                return -1;
            }
        }
