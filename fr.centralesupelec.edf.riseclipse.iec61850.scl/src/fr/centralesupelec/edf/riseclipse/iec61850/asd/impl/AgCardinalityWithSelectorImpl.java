...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Ag Cardinality With Selector</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.iec61850.asd.impl.AgCardinalityWithSelectorImpl#getCardinality <em>Cardinality</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.iec61850.asd.impl.AgCardinalityWithSelectorImpl#getMax <em>Max</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AgCardinalityWithSelectorImpl extends AgSelectorImpl implements AgCardinalityWithSelector {
    /**
     ...
     * @generated
     */
    protected AgCardinalityWithSelectorImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return AsdPackage.eINSTANCE.getAgCardinalityWithSelector();
    }
    ...
    public void setCardinality( CardinalityEnum newCardinality ) {
        ...
        if( eNotificationRequired() ) {
            eNotify( new ENotificationImpl( this, Notification.SET,
                    AsdPackage.AG_CARDINALITY_WITH_SELECTOR__CARDINALITY, oldCardinality, cardinality,
                    !oldCardinalityESet ) );
        }
    }
    ...
    public void unsetCardinality() {
        ...
        if( eNotificationRequired() ) {
            eNotify( new ENotificationImpl( this, Notification.UNSET,
                    AsdPackage.AG_CARDINALITY_WITH_SELECTOR__CARDINALITY, oldCardinality, CARDINALITY_EDEFAULT,
                    oldCardinalityESet ) );
        }
    }
    ...
    public void setMax( int newMax ) {
        ...
        max = newMax;
        if( eNotificationRequired() ) {
            eNotify( new ENotificationImpl( this, Notification.SET, AsdPackage.AG_CARDINALITY_WITH_SELECTOR__MAX,
                    oldMax, max ) );
        }
    }
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == AgCardinality.class ) {
            ...
            case AsdPackage.AG_CARDINALITY__CARDINALITY:
                return AsdPackage.AG_CARDINALITY_WITH_SELECTOR__CARDINALITY;
            case AsdPackage.AG_CARDINALITY__MAX:
                return AsdPackage.AG_CARDINALITY_WITH_SELECTOR__MAX;
            default:
                return -1;
            }
        }
