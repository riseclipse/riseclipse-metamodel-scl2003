...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Function Cat Ref</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.iec61850.asd.impl.FunctionCatRefImpl#getFunction <em>Function</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.iec61850.asd.impl.FunctionCatRefImpl#getFunctionUuid <em>Function Uuid</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.iec61850.asd.impl.FunctionCatRefImpl#getParentFunctionCategory <em>Parent Function Category</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.iec61850.asd.impl.FunctionCatRefImpl#getRefersToFunction <em>Refers To Function</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FunctionCatRefImpl extends BaseExtensionElementImpl implements FunctionCatRef {
    /**
    ...
    protected EClass eStaticClass() {
        return AsdPackage.eINSTANCE.getFunctionCatRef();
    }
    ...
    public void setFunction( String newFunction ) {
        ...
        if( eNotificationRequired() ) {
            eNotify( new ENotificationImpl( this, Notification.SET, AsdPackage.FUNCTION_CAT_REF__FUNCTION, oldFunction,
                    function ) );
        }
    }
    ...
    public void setFunctionUuid( String newFunctionUuid ) {
        ...
        if( eNotificationRequired() ) {
            eNotify( new ENotificationImpl( this, Notification.SET, AsdPackage.FUNCTION_CAT_REF__FUNCTION_UUID,
    ...
    public FunctionCategory getParentFunctionCategory() {
        if( eContainerFeatureID() != AsdPackage.FUNCTION_CAT_REF__PARENT_FUNCTION_CATEGORY ) {
            return null;
        }
    ...
    public NotificationChain basicSetParentFunctionCategory( FunctionCategory newParentFunctionCategory,
        ...
        msgs = eBasicSetContainer( ( InternalEObject ) newParentFunctionCategory,
                AsdPackage.FUNCTION_CAT_REF__PARENT_FUNCTION_CATEGORY, msgs );
        return msgs;
    }
    ...
    public void setParentFunctionCategory( FunctionCategory newParentFunctionCategory ) {
        if( newParentFunctionCategory != eInternalContainer()
                || ( eContainerFeatureID() != AsdPackage.FUNCTION_CAT_REF__PARENT_FUNCTION_CATEGORY
            ...
            if( newParentFunctionCategory != null ) {
                msgs = ( ( InternalEObject ) newParentFunctionCategory ).eInverseAdd( this,
                        AsdPackage.FUNCTION_CATEGORY__FUNCTION_CAT_REF, FunctionCategory.class, msgs );
            }
            ...
            eNotify( new ENotificationImpl( this, Notification.SET,
                    AsdPackage.FUNCTION_CAT_REF__PARENT_FUNCTION_CATEGORY, newParentFunctionCategory,
                    newParentFunctionCategory ) );
        }
    }
    ...
    public NotificationChain basicSetRefersToFunction( Function newRefersToFunction, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    AsdPackage.FUNCTION_CAT_REF__REFERS_TO_FUNCTION, oldRefersToFunction, newRefersToFunction,
        ...
        if( newRefersToFunction != refersToFunction ) {
            ...
            if( refersToFunction != null ) {
                msgs = ( ( InternalEObject ) refersToFunction ).eInverseRemove( this,
                        SclPackage.FUNCTION__REFERRED_BY_FUNCTION_CAT_REF, Function.class, msgs );
            }
            ...
            refersToFunctionESet = true;
            if( eNotificationRequired() ) {
                eNotify( new ENotificationImpl( this, Notification.SET, AsdPackage.FUNCTION_CAT_REF__REFERS_TO_FUNCTION,
    ...
    public NotificationChain basicUnsetRefersToFunction( NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.UNSET,
                    AsdPackage.FUNCTION_CAT_REF__REFERS_TO_FUNCTION, oldRefersToFunction, null,
                    oldRefersToFunctionESet );
            if( msgs == null ) {
                msgs = notification;
            }
        ...
        if( refersToFunction != null ) {
            ...
            if( eNotificationRequired() ) {
                eNotify( new ENotificationImpl( this, Notification.UNSET,
                        AsdPackage.FUNCTION_CAT_REF__REFERS_TO_FUNCTION, null, null, oldRefersToFunctionESet ) );
            }
        }
    }
    ...
    public NotificationChain eInverseAdd( InternalEObject otherEnd, int featureID, NotificationChain msgs ) {
        switch( featureID ) {
        case AsdPackage.FUNCTION_CAT_REF__PARENT_FUNCTION_CATEGORY:
            if( eInternalContainer() != null ) {
                msgs = eBasicRemoveFromContainer( msgs );
            }
            return basicSetParentFunctionCategory( ( FunctionCategory ) otherEnd, msgs );
        case AsdPackage.FUNCTION_CAT_REF__REFERS_TO_FUNCTION:
            if( refersToFunction != null ) {
                msgs = ( ( InternalEObject ) refersToFunction ).eInverseRemove( this,
                        SclPackage.FUNCTION__REFERRED_BY_FUNCTION_CAT_REF, Function.class, msgs );
            }
    ...
    public NotificationChain eBasicRemoveFromContainerFeature( NotificationChain msgs ) {
        ...
        case AsdPackage.FUNCTION_CAT_REF__PARENT_FUNCTION_CATEGORY:
            return eInternalContainer().eInverseRemove( this, AsdPackage.FUNCTION_CATEGORY__FUNCTION_CAT_REF,
    ...
    protected void doBuildExplicitLinks( @NonNull IRiseClipseConsole console ) {
        console.debug( EXPLICIT_LINK_CATEGORY, getFilename(), getLineNumber(),
                "FunctionCatRefImpl.doBuildExplicitLinks()" );

        // see Issue #13
        super.doBuildExplicitLinks( console );

        String messagePrefix = "while resolving link from FunctionCatRef: ";
        ...
        if( getFunctionUuid() != null && !getFunctionUuid().isEmpty() ) {
            ...
            if( res.getLeft() != null ) {
                ...
                console.info( EXPLICIT_LINK_CATEGORY, getFilename(), getLineNumber(),
                        "FunctionCatRef refers to Function( id = ", getFunctionUuid(), " ) on line ",
            ...
            if( function.getLeft() != null && function.getLeft() instanceof Function ) {
                ...
                console.info( EXPLICIT_LINK_CATEGORY, getFilename(), getLineNumber(),
                        "FunctionCatRef refers to Function( id = ", getRefersToFunction().getName(), " )", " on line ",
                        getRefersToFunction().getLineNumber() );
            }
            else {
                // console.warning( EXPLICIT_LINK_CATEGORY, getFilename(), getLineNumber(),
