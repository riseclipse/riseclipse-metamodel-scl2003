...
public class ServiceWithMaxImpl extends SclObjectImpl implements ServiceWithMax {
    ...
    * <!-- end-user-doc -->
    ...
    /**
	 * The cached validation expression for the '{@link #validateServiceWithMax_max_required(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Service With Max max required</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateServiceWithMax_max_required(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_SERVICE_WITH_MAX_MAX_REQUIRED_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION = "Tuple {\n" +
	 ...
	 * @generated
	 */
	public boolean validateServiceWithMax_max_required(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			SclValidator.validate
				(SclPackage.eINSTANCE.getServiceWithMax(),
				 this,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 SclPackage.eINSTANCE.getServiceWithMax__ValidateServiceWithMax_max_required__DiagnosticChain_Map(),
				 VALIDATE_SERVICE_WITH_MAX_MAX_REQUIRED_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION,
				 Diagnostic.ERROR,
				 SclValidator.DIAGNOSTIC_SOURCE,
				 SclValidator.SERVICE_WITH_MAX__VALIDATE_SERVICE_WITH_MAX_MAX_REQUIRED);
	}

				/**
	 * The cached validation expression for the '{@link #validateServiceWithMax_max_valid(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Service With Max max valid</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateServiceWithMax_max_valid(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_SERVICE_WITH_MAX_MAX_VALID_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION = "Tuple {\n" +
	 ...
	 * @generated
	 */
	public boolean validateServiceWithMax_max_valid(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			SclValidator.validate
				(SclPackage.eINSTANCE.getServiceWithMax(),
				 this,
				 ...
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 SclPackage.eINSTANCE.getServiceWithMax__ValidateServiceWithMax_max_valid__DiagnosticChain_Map(),
				 VALIDATE_SERVICE_WITH_MAX_MAX_VALID_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION,
				 Diagnostic.ERROR,
				 SclValidator.DIAGNOSTIC_SOURCE,
				 SclValidator.SERVICE_WITH_MAX__VALIDATE_SERVICE_WITH_MAX_MAX_VALID);
	}
