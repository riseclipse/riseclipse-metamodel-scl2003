...
public class LNodeTypeImpl extends IDNamingImpl implements LNodeType {
    ...
    /**
	 * The cached validation expression for the '{@link #validateLNodeType_lnClass_required(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate LNode Type ln Class required</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateLNodeType_lnClass_required(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_LNODE_TYPE_LN_CLASS_REQUIRED_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION = "Tuple {\n" +
		"\tmessage : String = 'lnClass attribute shall be present in LNodeType (line ' + self.lineNumber.toString() + ')' ,\n" +
		"\tstatus : Boolean = \n" +
		"        self.lnClass <> null\n" +
		"\n" +
		"    \n" +
	 ...
	 * @generated
	 */
	public boolean validateLNodeType_lnClass_required(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			SclValidator.validate
				(SclPackage.eINSTANCE.getLNodeType(),
				 this,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 SclPackage.eINSTANCE.getLNodeType__ValidateLNodeType_lnClass_required__DiagnosticChain_Map(),
				 VALIDATE_LNODE_TYPE_LN_CLASS_REQUIRED_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION,
				 Diagnostic.ERROR,
				 SclValidator.DIAGNOSTIC_SOURCE,
				 SclValidator.LNODE_TYPE__VALIDATE_LNODE_TYPE_LN_CLASS_REQUIRED);
	}

				/**
	 * The cached validation expression for the '{@link #validateLNodeType_lnClass_valid(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate LNode Type ln Class valid</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateLNodeType_lnClass_valid(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_LNODE_TYPE_LN_CLASS_VALID_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION = "Tuple {\n" +
		"\tmessage : String = 'lnClass attribute shall be valid in LNodeType (line ' + self.lineNumber.toString() + '). '\n" +
	 ...
	 * @generated
	 */
	public boolean validateLNodeType_lnClass_valid(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			SclValidator.validate
				(SclPackage.eINSTANCE.getLNodeType(),
				 this,
				 ...
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 SclPackage.eINSTANCE.getLNodeType__ValidateLNodeType_lnClass_valid__DiagnosticChain_Map(),
				 VALIDATE_LNODE_TYPE_LN_CLASS_VALID_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION,
				 Diagnostic.ERROR,
				 SclValidator.DIAGNOSTIC_SOURCE,
				 SclValidator.LNODE_TYPE__VALIDATE_LNODE_TYPE_LN_CLASS_VALID);
	}

				/**
	 * The cached validation expression for the '{@link #validateHistory_at_least_one_DO_required(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate History at least one DO required</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateHistory_at_least_one_DO_required(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_HISTORY_AT_LEAST_ONE_DO_REQUIRED_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION = "Tuple {\n" +
		"\tmessage : String = 'LNodeType shall contain at least one DO (line ' + self.lineNumber.toString() + ')' ,\n" +
		"\tstatus : Boolean = \n" +
		"        self.DO->notEmpty()\n" +
		"\n" +
		"\n" +
	 ...
	 * @generated
	 */
	public boolean validateHistory_at_least_one_DO_required(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			SclValidator.validate
				(SclPackage.eINSTANCE.getLNodeType(),
				 this,
				 ...
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 SclPackage.eINSTANCE.getLNodeType__ValidateHistory_at_least_one_DO_required__DiagnosticChain_Map(),
				 VALIDATE_HISTORY_AT_LEAST_ONE_DO_REQUIRED_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION,
				 Diagnostic.ERROR,
				 SclValidator.DIAGNOSTIC_SOURCE,
				 SclValidator.LNODE_TYPE__VALIDATE_HISTORY_AT_LEAST_ONE_DO_REQUIRED);
	}
