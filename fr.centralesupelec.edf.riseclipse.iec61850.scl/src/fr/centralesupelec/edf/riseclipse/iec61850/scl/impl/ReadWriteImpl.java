 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.iec61850.scl.impl.ReadWriteImpl#getServices <em>Services</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReadWriteImpl extends ServiceYesNoImpl implements ReadWrite {
    ...
    protected EClass eStaticClass() {
		return SclPackage.Literals.READ_WRITE;
	}
    ...
    public NotificationChain basicSetServices( Services newServices, NotificationChain msgs ) {
		msgs = eBasicSetContainer((InternalEObject)newServices, SclPackage.READ_WRITE__SERVICES, msgs);
		return msgs;
	}
    ...
    public void setServices( Services newServices ) {
		if (newServices != eInternalContainer() || (eContainerFeatureID() != SclPackage.READ_WRITE__SERVICES && newServices != null)) {
			...
			if (newServices != null)
				msgs = ((InternalEObject)newServices).eInverseAdd(this, SclPackage.SERVICES__READ_WRITE, Services.class, msgs);
			msgs = basicSetServices(newServices, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SclPackage.READ_WRITE__SERVICES, newServices, newServices));
	}
    ...
    public NotificationChain eInverseAdd( InternalEObject otherEnd, int featureID, NotificationChain msgs ) {
		switch (featureID) {
			case SclPackage.READ_WRITE__SERVICES:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
