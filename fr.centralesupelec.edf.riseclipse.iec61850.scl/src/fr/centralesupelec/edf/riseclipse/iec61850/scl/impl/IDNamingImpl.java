...
public class IDNamingImpl extends BaseElementImpl implements IDNaming {
    ...
    protected EClass eStaticClass() {
		return SclPackage.Literals.ID_NAMING;
	}
	...
	public boolean validateIDNaming_id_valid(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		if (le) {
			...
			try {
				final /*@NonInvalid*/ String id = this.getId();
				final /*@NonInvalid*/ boolean ne = id != null;
				/*@Thrown*/ boolean status;
				if (ne) {
					final /*@Thrown*/ boolean validSclName = ((SclObject)this).validSclName(id);
					status = validSclName;
				}
				else {
				...
				if (status) {
					...
					final /*@Thrown*/ String toString_1 = OclAnyToStringOperation.INSTANCE.evaluate(id);
