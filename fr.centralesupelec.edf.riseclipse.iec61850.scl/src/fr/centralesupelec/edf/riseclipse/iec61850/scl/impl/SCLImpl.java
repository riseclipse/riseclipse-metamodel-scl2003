...
public class SCLImpl extends BaseElementImpl implements SCL {
    ...
    protected EClass eStaticClass() {
		return SclPackage.Literals.SCL;
	}
	...
	public boolean validateSCL_version_valid(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		if (le) {
			...
			try {
				final /*@NonInvalid*/ String version = this.getVersion();
				final /*@NonInvalid*/ boolean ne = version != null;
				/*@Thrown*/ boolean status;
				if (ne) {
					final /*@Thrown*/ boolean validSclVersion = ((SclObject)this).validSclVersion(version);
				...
				if (status) {
					...
					final /*@Thrown*/ String toString_0 = OclAnyToStringOperation.INSTANCE.evaluate(version);
