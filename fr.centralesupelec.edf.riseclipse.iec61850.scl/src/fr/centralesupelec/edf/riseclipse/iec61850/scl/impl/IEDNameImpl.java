...
public class IEDNameImpl extends ExplicitLinkResolverImpl implements IEDName {
    ...
    /**
	 * The cached validation expression for the '{@link #validateIEDName_value_valid(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate IED Name value valid</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateIEDName_value_valid(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_IED_NAME_VALUE_VALID_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION = "Tuple {\n" +
	 ...
	 * @generated
	 */
	public boolean validateIEDName_value_valid(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			SclValidator.validate
				(SclPackage.eINSTANCE.getIEDName(),
				 this,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 SclPackage.eINSTANCE.getIEDName__ValidateIEDName_value_valid__DiagnosticChain_Map(),
				 VALIDATE_IED_NAME_VALUE_VALID_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION,
				 Diagnostic.ERROR,
				 SclValidator.DIAGNOSTIC_SOURCE,
				 SclValidator.IED_NAME__VALIDATE_IED_NAME_VALUE_VALID);
	}
