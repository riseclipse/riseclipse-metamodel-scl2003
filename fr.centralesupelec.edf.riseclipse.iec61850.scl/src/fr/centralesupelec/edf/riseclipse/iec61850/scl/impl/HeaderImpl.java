...
public class HeaderImpl extends SclObjectImpl implements Header {
    ...
    /**
	 * The cached validation expression for the '{@link #validateHeader_id_required(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Header id required</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateHeader_id_required(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_HEADER_ID_REQUIRED_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION = "Tuple {\n" +
	 ...
	 * @generated
	 */
	public boolean validateHeader_id_required(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			SclValidator.validate
				(SclPackage.eINSTANCE.getHeader(),
				 this,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 SclPackage.eINSTANCE.getHeader__ValidateHeader_id_required__DiagnosticChain_Map(),
				 VALIDATE_HEADER_ID_REQUIRED_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION,
				 Diagnostic.ERROR,
				 SclValidator.DIAGNOSTIC_SOURCE,
				 SclValidator.HEADER__VALIDATE_HEADER_ID_REQUIRED);
	}

				/**
	 * The cached validation expression for the '{@link #validateHeader_nameStructure_value_IEDName(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Header name Structure value IED Name</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateHeader_nameStructure_value_IEDName(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_HEADER_NAME_STRUCTURE_VALUE_IED_NAME_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION = "Tuple {\n" +
	 ...
	 * @generated
	 */
	public boolean validateHeader_nameStructure_value_IEDName(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			SclValidator.validate
				(SclPackage.eINSTANCE.getHeader(),
				 this,
				 ...
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 SclPackage.eINSTANCE.getHeader__ValidateHeader_nameStructure_value_IEDName__DiagnosticChain_Map(),
				 VALIDATE_HEADER_NAME_STRUCTURE_VALUE_IED_NAME_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION,
				 Diagnostic.ERROR,
				 SclValidator.DIAGNOSTIC_SOURCE,
				 SclValidator.HEADER__VALIDATE_HEADER_NAME_STRUCTURE_VALUE_IED_NAME);
	}
