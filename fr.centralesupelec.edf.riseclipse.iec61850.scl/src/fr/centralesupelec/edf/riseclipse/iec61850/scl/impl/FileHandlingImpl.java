...
public class FileHandlingImpl extends SclObjectImpl implements FileHandling {
    ...
    * <!-- end-user-doc -->
    ...
    /**
	 * The cached validation expression for the '{@link #validateFileHandling_nothing(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate File Handling nothing</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateFileHandling_nothing(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_FILE_HANDLING_NOTHING_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION = "\n" +
		"        true\n" +
		"\n" +
		"\n" +
		"";
	 ...
	 * @generated
	 */
	public boolean validateFileHandling_nothing(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			SclValidator.validate
				(SclPackage.eINSTANCE.getFileHandling(),
				 this,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 SclPackage.eINSTANCE.getFileHandling__ValidateFileHandling_nothing__DiagnosticChain_Map(),
				 VALIDATE_FILE_HANDLING_NOTHING_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION,
				 Diagnostic.ERROR,
				 SclValidator.DIAGNOSTIC_SOURCE,
				 SclValidator.FILE_HANDLING__VALIDATE_FILE_HANDLING_NOTHING);
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case SclPackage.FILE_HANDLING___VALIDATE_FILE_HANDLING_NOTHING__DIAGNOSTICCHAIN_MAP:
				return validateFileHandling_nothing((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
		}
