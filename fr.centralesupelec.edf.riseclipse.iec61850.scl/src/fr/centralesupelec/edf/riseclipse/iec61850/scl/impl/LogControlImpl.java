...
public class LogControlImpl extends ControlWithTriggerOptImpl implements LogControl {
    ...
    protected EClass eStaticClass() {
		return SclPackage.Literals.LOG_CONTROL;
	}
    ...
    * <!-- end-user-doc -->
	...
	public boolean validateLogControl_logName_valid(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		if (le) {
			...
			try {
				final /*@NonInvalid*/ String logName = this.getLogName();
				final /*@NonInvalid*/ boolean ne = logName != null;
				/*@Thrown*/ boolean status;
				if (ne) {
					final /*@Thrown*/ boolean validSclLogName = ((SclObject)this).validSclLogName(logName);
				...
				if (status) {
					...
					final /*@Thrown*/ String toString_0 = OclAnyToStringOperation.INSTANCE.evaluate(logName);
