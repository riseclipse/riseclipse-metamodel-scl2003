 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.iec61850.scl.impl.DynAssociationImpl#getServices <em>Services</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DynAssociationImpl extends ServiceWithOptionalMaxImpl implements DynAssociation {
    ...
    protected EClass eStaticClass() {
		return SclPackage.Literals.DYN_ASSOCIATION;
	}
    ...
    public NotificationChain basicSetServices( Services newServices, NotificationChain msgs ) {
		msgs = eBasicSetContainer((InternalEObject)newServices, SclPackage.DYN_ASSOCIATION__SERVICES, msgs);
		return msgs;
	}
    ...
    public void setServices( Services newServices ) {
		if (newServices != eInternalContainer() || (eContainerFeatureID() != SclPackage.DYN_ASSOCIATION__SERVICES && newServices != null)) {
			...
			if (newServices != null)
				msgs = ((InternalEObject)newServices).eInverseAdd(this, SclPackage.SERVICES__DYN_ASSOCIATION, Services.class, msgs);
			msgs = basicSetServices(newServices, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SclPackage.DYN_ASSOCIATION__SERVICES, newServices, newServices));
	}
    ...
    public NotificationChain eInverseAdd( InternalEObject otherEnd, int featureID, NotificationChain msgs ) {
		switch (featureID) {
			case SclPackage.DYN_ASSOCIATION__SERVICES:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
