...
public class ProtNsImpl extends SclObjectImpl implements ProtNs {
    ...
    protected EClass eStaticClass() {
		return SclPackage.Literals.PROT_NS;
	}
	 ...
	 * @generated
	 */
	public boolean validateProtNs_value_required(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		/**
		 *
		...
		final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, SclTables.STR_ProtNs_c_c_ProtNs_value_required);
		...
		if (le) {
			...
			final /*@NonInvalid*/ boolean status = value != null;
			...
			if (status) {
				...
				final /*@NonInvalid*/ String sum = StringConcatOperation.INSTANCE.evaluate(SclTables.STR_value_32_shall_32_be_32_present_32_in_32_ProtNs_32_o_line_32, toString);
			...
			final /*@NonInvalid*/ boolean logDiagnostic = CGStringLogDiagnosticOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, SclTables.STR_ProtNs_c_c_ProtNs_value_required, this, (Object)null, diagnostics, context, (Object)null, severity_0, symbol_1, SclTables.INT_0).booleanValue();
	 ...
	 * @generated
	 */
	public boolean validateProtNs_value_valid(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		/**
		 *
		 ...
		 */
		final /*@NonInvalid*/ Executor executor = PivotUtilInternal.getExecutor(this);
		final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, SclTables.STR_ProtNs_c_c_ProtNs_value_valid);
		final /*@NonInvalid*/ boolean le = OclComparableLessThanEqualOperation.INSTANCE.evaluate(executor, severity_0, SclTables.INT_0).booleanValue();
		/*@NonInvalid*/ Object symbol_2;
		if (le) {
			symbol_2 = ValueUtil.TRUE_VALUE;
			...
			try {
				...
				if (ne) {
					final /*@Thrown*/ boolean validSclNamespaceName = ((SclObject)this).validSclNamespaceName(value);
				...
				if (status) {
					...
					final /*@NonInvalid*/ IntegerValue BOXED_lineNumber = ValueUtil.integerValueOf(lineNumber);
					final /*@NonInvalid*/ String toString = OclAnyToStringOperation.INSTANCE.evaluate(BOXED_lineNumber);
					final /*@NonInvalid*/ String sum = StringConcatOperation.INSTANCE.evaluate(SclTables.STR_value_32_shall_32_be_32_valid_32_in_32_ProtNs_32_o_line_32, toString);
			...
			final /*@NonInvalid*/ boolean logDiagnostic = CGStringLogDiagnosticOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, SclTables.STR_ProtNs_c_c_ProtNs_value_valid, this, (Object)null, diagnostics, context, (Object)null, severity_0, CAUGHT_symbol_1, SclTables.INT_0).booleanValue();
			symbol_2 = logDiagnostic;
		}
		return Boolean.TRUE == symbol_2;
	}
	 ...
	 * @generated
	 */
	public boolean validateProtNs_type_valid(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		/**
		 *
		 ...
		 */
		final /*@NonInvalid*/ Executor executor = PivotUtilInternal.getExecutor(this);
		final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, SclTables.STR_ProtNs_c_c_ProtNs_type_valid);
		final /*@NonInvalid*/ boolean le = OclComparableLessThanEqualOperation.INSTANCE.evaluate(executor, severity_0, SclTables.INT_0).booleanValue();
		/*@NonInvalid*/ Object symbol_2;
		if (le) {
			symbol_2 = ValueUtil.TRUE_VALUE;
			...
			try {
				...
				/*@Thrown*/ boolean status;
				if (ne) {
					final /*@Thrown*/ IntegerValue size = StringSizeOperation.INSTANCE.evaluate(type);
				...
				if (status) {
					...
					final /*@NonInvalid*/ IntegerValue BOXED_lineNumber = ValueUtil.integerValueOf(lineNumber);
					final /*@NonInvalid*/ String toString = OclAnyToStringOperation.INSTANCE.evaluate(BOXED_lineNumber);
					final /*@NonInvalid*/ String sum = StringConcatOperation.INSTANCE.evaluate(SclTables.STR_type_32_attribute_32_shall_32_be_32_valid_32_in_32_ProtNs_32_o_line_32, toString);
					final /*@NonInvalid*/ String sum_0 = StringConcatOperation.INSTANCE.evaluate(sum, SclTables.STR__e__32);
					final /*@NonInvalid*/ String sum_1 = StringConcatOperation.INSTANCE.evaluate(sum_0, SclTables.STR_Current_32_value_32_is_32);
			...
			final /*@NonInvalid*/ boolean logDiagnostic = CGStringLogDiagnosticOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, SclTables.STR_ProtNs_c_c_ProtNs_type_valid, this, (Object)null, diagnostics, context, (Object)null, severity_0, CAUGHT_symbol_1, SclTables.INT_0).booleanValue();
			symbol_2 = logDiagnostic;
		}
		return Boolean.TRUE == symbol_2;
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case SclPackage.PROT_NS___VALIDATE_PROT_NS_VALUE_REQUIRED__DIAGNOSTICCHAIN_MAP:
				return validateProtNs_value_required((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case SclPackage.PROT_NS___VALIDATE_PROT_NS_VALUE_VALID__DIAGNOSTICCHAIN_MAP:
				return validateProtNs_value_valid((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case SclPackage.PROT_NS___VALIDATE_PROT_NS_TYPE_VALID__DIAGNOSTICCHAIN_MAP:
				return validateProtNs_type_valid((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
		}
