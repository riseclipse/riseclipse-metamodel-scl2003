 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.iec61850.scl.TimerActivatedControl#getServices <em>Services</em>}</li>
 * </ul>
 *
...
public interface TimerActivatedControl extends ServiceYesNo {
	 ...
	 * @see fr.centralesupelec.edf.riseclipse.iec61850.scl.SclPackage#getTimerActivatedControl_Services()
	 * @see fr.centralesupelec.edf.riseclipse.iec61850.scl.Services#getTimerActivatedControl
	 * @model opposite="TimerActivatedControl" resolveProxies="false" unsettable="true"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel get='throw new UnsupportedOperationException();  // FIXME Unimplemented http://www.iec.ch/61850/2003/SCL!TimerActivatedControl!Services'"
	 * @generated
	 */
    Services getServices();

    /**
	 * Sets the value of the '{@link fr.centralesupelec.edf.riseclipse.iec61850.scl.TimerActivatedControl#getServices <em>Services</em>}' container reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
