...
public abstract class AnyContentFromOtherNamespaceImpl extends SclObjectImpl implements AnyContentFromOtherNamespace {
    ...
    protected EClass eStaticClass() {
		return SclPackage.Literals.ANY_CONTENT_FROM_OTHER_NAMESPACE;
	}
    ...
    public FeatureMap getGroup() {
		return (FeatureMap)getMixed().<FeatureMap.Entry>list(SclPackage.Literals.ANY_CONTENT_FROM_OTHER_NAMESPACE__GROUP);
	}
    ...
    public FeatureMap getAny() {
		return (FeatureMap)getGroup().<FeatureMap.Entry>list(SclPackage.Literals.ANY_CONTENT_FROM_OTHER_NAMESPACE__ANY);
	}
