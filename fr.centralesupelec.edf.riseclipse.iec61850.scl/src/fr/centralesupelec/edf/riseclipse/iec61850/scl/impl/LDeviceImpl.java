...
public class LDeviceImpl extends UnNamingImpl implements LDevice {
    ...
    /**
	 * The cached validation expression for the '{@link #validateLDevice_inst_required(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate LDevice inst required</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateLDevice_inst_required(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_LDEVICE_INST_REQUIRED_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION = "Tuple {\n" +
	 ...
	 * @generated
	 */
	public boolean validateLDevice_inst_required(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			SclValidator.validate
				(SclPackage.eINSTANCE.getLDevice(),
				 this,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 SclPackage.eINSTANCE.getLDevice__ValidateLDevice_inst_required__DiagnosticChain_Map(),
				 VALIDATE_LDEVICE_INST_REQUIRED_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION,
				 Diagnostic.ERROR,
				 SclValidator.DIAGNOSTIC_SOURCE,
				 SclValidator.LDEVICE__VALIDATE_LDEVICE_INST_REQUIRED);
	}

				/**
	 * The cached validation expression for the '{@link #validateLDevice_inst_valid(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate LDevice inst valid</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateLDevice_inst_valid(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_LDEVICE_INST_VALID_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION = "Tuple {\n" +
	 ...
	 * @generated
	 */
	public boolean validateLDevice_inst_valid(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			SclValidator.validate
				(SclPackage.eINSTANCE.getLDevice(),
				 this,
				 ...
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 SclPackage.eINSTANCE.getLDevice__ValidateLDevice_inst_valid__DiagnosticChain_Map(),
				 VALIDATE_LDEVICE_INST_VALID_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION,
				 Diagnostic.ERROR,
				 SclValidator.DIAGNOSTIC_SOURCE,
				 SclValidator.LDEVICE__VALIDATE_LDEVICE_INST_VALID);
	}

				/**
	 * The cached validation expression for the '{@link #validateLDevice_ldName_valid(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate LDevice ld Name valid</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateLDevice_ldName_valid(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_LDEVICE_LD_NAME_VALID_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION = "Tuple {\n" +
	 ...
	 * @generated
	 */
	public boolean validateLDevice_ldName_valid(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			SclValidator.validate
				(SclPackage.eINSTANCE.getLDevice(),
				 this,
				 ...
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 SclPackage.eINSTANCE.getLDevice__ValidateLDevice_ldName_valid__DiagnosticChain_Map(),
				 VALIDATE_LDEVICE_LD_NAME_VALID_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION,
				 Diagnostic.ERROR,
				 SclValidator.DIAGNOSTIC_SOURCE,
				 SclValidator.LDEVICE__VALIDATE_LDEVICE_LD_NAME_VALID);
	}

				/**
	 * The cached validation expression for the '{@link #validateLDevice_one_LN0_required(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate LDevice one LN0 required</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateLDevice_one_LN0_required(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_LDEVICE_ONE_LN0_REQUIRED_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION = "Tuple {\n" +
	 ...
	 * @generated
	 */
	public boolean validateLDevice_one_LN0_required(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			SclValidator.validate
				(SclPackage.eINSTANCE.getLDevice(),
				 this,
				 ...
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 SclPackage.eINSTANCE.getLDevice__ValidateLDevice_one_LN0_required__DiagnosticChain_Map(),
				 VALIDATE_LDEVICE_ONE_LN0_REQUIRED_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION,
				 Diagnostic.ERROR,
				 SclValidator.DIAGNOSTIC_SOURCE,
				 SclValidator.LDEVICE__VALIDATE_LDEVICE_ONE_LN0_REQUIRED);
	}
