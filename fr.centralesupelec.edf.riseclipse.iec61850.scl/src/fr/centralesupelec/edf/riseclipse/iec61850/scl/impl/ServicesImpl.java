...
public class ServicesImpl extends SclObjectImpl implements Services {
    ...
    /**
	 * The cached validation expression for the '{@link #validateServices_nameLength_valid(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Services name Length valid</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateServices_nameLength_valid(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_SERVICES_NAME_LENGTH_VALID_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION = "Tuple {\n" +
		"\tmessage : String = 'nameLength attribute shall be valid in Services (line ' + self.lineNumber.toString() + '). '\n" +
		"          + 'Current value is ' + self.nameLength.toString()\n" +
		"        ,\n" +
		"\tstatus : Boolean = \n" +
	 ...
	 * @generated
	 */
	public boolean validateServices_nameLength_valid(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			SclValidator.validate
				(SclPackage.eINSTANCE.getServices(),
				 this,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 SclPackage.eINSTANCE.getServices__ValidateServices_nameLength_valid__DiagnosticChain_Map(),
				 VALIDATE_SERVICES_NAME_LENGTH_VALID_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION,
				 Diagnostic.ERROR,
				 SclValidator.DIAGNOSTIC_SOURCE,
				 SclValidator.SERVICES__VALIDATE_SERVICES_NAME_LENGTH_VALID);
	}
