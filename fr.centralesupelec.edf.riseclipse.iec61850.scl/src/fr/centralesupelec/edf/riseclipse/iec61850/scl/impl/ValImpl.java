...
public class ValImpl extends SclObjectImpl implements Val {
    ...
    * <!-- end-user-doc -->
    ...
    protected EClass eStaticClass() {
		return SclPackage.Literals.VAL;
	}
    ...
    * <!-- end-user-doc -->
	...
	public boolean validateVal_sGroup_valid(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		if (le) {
			...
			try {
				final /*@NonInvalid*/ Integer sGroup = this.getSGroup();
				final /*@NonInvalid*/ IntegerValue BOXED_sGroup = sGroup == null ? null : ValueUtil.integerValueOf(sGroup);
				final /*@NonInvalid*/ boolean ne = BOXED_sGroup != null;
				/*@Thrown*/ boolean status;
				if (ne) {
					final /*@Thrown*/ boolean ge = OclComparableGreaterThanEqualOperation.INSTANCE.evaluate(executor, BOXED_sGroup, SclTables.INT_0).booleanValue();
					status = ge;
				}
				else {
				...
				if (status) {
					...
					final /*@Thrown*/ String toString_0 = OclAnyToStringOperation.INSTANCE.evaluate(BOXED_sGroup);
