...
public class TransformerWindingImpl extends AbstractConductingEquipmentImpl implements TransformerWinding {
    ...
    /**
	 * The cached validation expression for the '{@link #validateTransformerWinding_type_required(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Transformer Winding type required</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateTransformerWinding_type_required(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_TRANSFORMER_WINDING_TYPE_REQUIRED_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION = "Tuple {\n" +
		"\tmessage : String = 'type attribute shall be PTW in TransformerWinding (line ' + self.lineNumber.toString() + '). '\n" +
	 ...
	 * @generated
	 */
	public boolean validateTransformerWinding_type_required(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			SclValidator.validate
				(SclPackage.eINSTANCE.getTransformerWinding(),
				 this,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 SclPackage.eINSTANCE.getTransformerWinding__ValidateTransformerWinding_type_required__DiagnosticChain_Map(),
				 VALIDATE_TRANSFORMER_WINDING_TYPE_REQUIRED_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION,
				 Diagnostic.ERROR,
				 SclValidator.DIAGNOSTIC_SOURCE,
				 SclValidator.TRANSFORMER_WINDING__VALIDATE_TRANSFORMER_WINDING_TYPE_REQUIRED);
	}
