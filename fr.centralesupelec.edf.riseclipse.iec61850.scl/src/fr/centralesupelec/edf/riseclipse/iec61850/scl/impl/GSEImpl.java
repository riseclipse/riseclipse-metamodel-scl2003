...
public class GSEImpl extends ControlBlockImpl implements GSE {
    ...
    * <!-- end-user-doc -->
    ...
    /**
	 * The cached validation expression for the '{@link #validateGSE_nothing(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate GSE nothing</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateGSE_nothing(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_GSE_NOTHING_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION = "\n" +
		"        true\n" +
		"\n" +
		"\n" +
		"\n" +
	 ...
	 * @generated
	 */
	public boolean validateGSE_nothing(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			SclValidator.validate
				(SclPackage.eINSTANCE.getGSE(),
				 this,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 SclPackage.eINSTANCE.getGSE__ValidateGSE_nothing__DiagnosticChain_Map(),
				 VALIDATE_GSE_NOTHING_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION,
				 Diagnostic.ERROR,
				 SclValidator.DIAGNOSTIC_SOURCE,
				 SclValidator.GSE__VALIDATE_GSE_NOTHING);
	}
