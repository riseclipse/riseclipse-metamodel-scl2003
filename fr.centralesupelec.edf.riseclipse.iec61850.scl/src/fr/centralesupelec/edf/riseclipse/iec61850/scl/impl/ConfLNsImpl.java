...
public class ConfLNsImpl extends SclObjectImpl implements ConfLNs {
    ...
    protected EClass eStaticClass() {
		return SclPackage.eINSTANCE.getConfLNs();
	}
    ...
    * <!-- end-user-doc -->
    ...
    /**
	 * The cached validation expression for the '{@link #validateConfLNs_nothing(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Conf LNs nothing</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateConfLNs_nothing(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_CONF_LNS_NOTHING_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION = "\n" +
		"        true\n" +
		"\n" +
		"\n" +
		"";
	 ...
	 * @generated
	 */
	public boolean validateConfLNs_nothing(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			SclValidator.validate
				(SclPackage.eINSTANCE.getConfLNs(),
				 this,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 SclPackage.eINSTANCE.getConfLNs__ValidateConfLNs_nothing__DiagnosticChain_Map(),
				 VALIDATE_CONF_LNS_NOTHING_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION,
				 Diagnostic.ERROR,
				 SclValidator.DIAGNOSTIC_SOURCE,
				 SclValidator.CONF_LNS__VALIDATE_CONF_LNS_NOTHING);
	}
