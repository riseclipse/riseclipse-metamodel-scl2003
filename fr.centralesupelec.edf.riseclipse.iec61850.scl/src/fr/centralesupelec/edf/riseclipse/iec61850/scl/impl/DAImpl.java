...
public class DAImpl extends AbstractDataAttributeImpl implements DA {
    ...
    * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public boolean validateDA_fc_required(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		/**
		 *
		 * inv DA_fc_required:
		...
		final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, SclTables.STR_DA_c_c_DA_fc_required);
		...
		if (le) {
			...
			if (status) {
				...
				final /*@NonInvalid*/ String sum = StringConcatOperation.INSTANCE.evaluate(SclTables.STR_fc_32_attribute_32_shall_32_be_32_present_32_in_32_DA_32_o_line_32, toString);
			...
			final /*@NonInvalid*/ boolean logDiagnostic = CGStringLogDiagnosticOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, SclTables.STR_DA_c_c_DA_fc_required, this, (Object)null, diagnostics, context, (Object)null, severity_0, symbol_1, SclTables.INT_0).booleanValue();
