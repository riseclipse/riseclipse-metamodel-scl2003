...
public class DAImpl extends AbstractDataAttributeImpl implements DA {
    ...
    * <!-- end-user-doc -->
    ...
    /**
	 * The cached validation expression for the '{@link #validateDA_fc_required(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate DA fc required</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateDA_fc_required(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_DA_FC_REQUIRED_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION = "Tuple {\n" +
		"\tmessage : String = 'fc attribute shall be present in DA (line ' + self.lineNumber.toString() + ')' ,\n" +
		"\tstatus : Boolean = \n" +
		"        self.fc <> null\n" +
		"\n" +
		"    \n" +
	 ...
	 * @generated
	 */
	public boolean validateDA_fc_required(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			SclValidator.validate
				(SclPackage.eINSTANCE.getDA(),
				 this,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 SclPackage.eINSTANCE.getDA__ValidateDA_fc_required__DiagnosticChain_Map(),
				 VALIDATE_DA_FC_REQUIRED_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION,
				 Diagnostic.ERROR,
				 SclValidator.DIAGNOSTIC_SOURCE,
				 SclValidator.DA__VALIDATE_DA_FC_REQUIRED);
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case SclPackage.DA___VALIDATE_DA_FC_REQUIRED__DIAGNOSTICCHAIN_MAP:
				return validateDA_fc_required((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
		}
