...
public class GSEControlImpl extends ControlWithIEDNameImpl implements GSEControl {
    ...
    protected EClass eStaticClass() {
		return SclPackage.Literals.GSE_CONTROL;
	}
    ...
    * <!-- end-user-doc -->
	...
	public boolean validateGSEControl_appID_valid(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		if (le) {
			...
			try {
				final /*@NonInvalid*/ String appID = this.getAppID();
				final /*@NonInvalid*/ boolean ne = appID != null;
				/*@Thrown*/ boolean status;
				if (ne) {
					final /*@Thrown*/ boolean validSclMessageID = ((SclObject)this).validSclMessageID(appID);
				...
				if (status) {
					...
					final /*@Thrown*/ String toString_0 = OclAnyToStringOperation.INSTANCE.evaluate(appID);
