...
public class ServiceConfReportControlImpl extends ServiceWithMaxImpl implements ServiceConfReportControl {
    ...
    /**
	 * The cached validation expression for the '{@link #validateServiceConfReportControl_nothing(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Service Conf Report Control nothing</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateServiceConfReportControl_nothing(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_SERVICE_CONF_REPORT_CONTROL_NOTHING_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION = "\n" +
		"        true\n" +
		"\n" +
		"\n" +
		"";
	 ...
	 * @generated
	 */
	public boolean validateServiceConfReportControl_nothing(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			SclValidator.validate
				(SclPackage.eINSTANCE.getServiceConfReportControl(),
				 this,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 SclPackage.eINSTANCE.getServiceConfReportControl__ValidateServiceConfReportControl_nothing__DiagnosticChain_Map(),
				 VALIDATE_SERVICE_CONF_REPORT_CONTROL_NOTHING_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION,
				 Diagnostic.ERROR,
				 SclValidator.DIAGNOSTIC_SOURCE,
				 SclValidator.SERVICE_CONF_REPORT_CONTROL__VALIDATE_SERVICE_CONF_REPORT_CONTROL_NOTHING);
	}
