...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>IED Source Files</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.iec61850.scl.impl.IEDSourceFilesImpl#getSclFileReference <em>Scl File Reference</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.iec61850.scl.impl.IEDSourceFilesImpl#getParentIED <em>Parent IED</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IEDSourceFilesImpl extends BaseElementImpl implements IEDSourceFiles {
    /**
    ...
    protected EClass eStaticClass() {
        return SclPackage.eINSTANCE.getIEDSourceFiles();
    }
    ...
    public EList< SclFileReference > getSclFileReference() {
        if( sclFileReference == null ) {
            sclFileReference = new EObjectContainmentEList.Unsettable< SclFileReference >( SclFileReference.class, this,
    ...
    public IED getParentIED() {
        if( eContainerFeatureID() != SclPackage.IED_SOURCE_FILES__PARENT_IED ) {
            return null;
        }
    ...
    public NotificationChain basicSetParentIED( IED newParentIED, NotificationChain msgs ) {
        msgs = eBasicSetContainer( ( InternalEObject ) newParentIED, SclPackage.IED_SOURCE_FILES__PARENT_IED, msgs );
        return msgs;
    }
    ...
    public void setParentIED( IED newParentIED ) {
        if( newParentIED != eInternalContainer()
                || ( eContainerFeatureID() != SclPackage.IED_SOURCE_FILES__PARENT_IED && newParentIED != null ) ) {
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, SclPackage.IED_SOURCE_FILES__PARENT_IED,
