...
public class ServiceWithMaxAndModifyImpl extends ServiceWithMaxImpl implements ServiceWithMaxAndModify {
    ...
    /**
	 * The cached validation expression for the '{@link #validateServiceWithMaxAndModify_nothing(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Service With Max And Modify nothing</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateServiceWithMaxAndModify_nothing(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_SERVICE_WITH_MAX_AND_MODIFY_NOTHING_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION = "\n" +
		"        true\n" +
		"\n" +
		"\n" +
		"";
	 ...
	 * @generated
	 */
	public boolean validateServiceWithMaxAndModify_nothing(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			SclValidator.validate
				(SclPackage.eINSTANCE.getServiceWithMaxAndModify(),
				 this,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 SclPackage.eINSTANCE.getServiceWithMaxAndModify__ValidateServiceWithMaxAndModify_nothing__DiagnosticChain_Map(),
				 VALIDATE_SERVICE_WITH_MAX_AND_MODIFY_NOTHING_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION,
				 Diagnostic.ERROR,
				 SclValidator.DIAGNOSTIC_SOURCE,
				 SclValidator.SERVICE_WITH_MAX_AND_MODIFY__VALIDATE_SERVICE_WITH_MAX_AND_MODIFY_NOTHING);
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case SclPackage.SERVICE_WITH_MAX_AND_MODIFY___VALIDATE_SERVICE_WITH_MAX_AND_MODIFY_NOTHING__DIAGNOSTICCHAIN_MAP:
				return validateServiceWithMaxAndModify_nothing((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
		}
