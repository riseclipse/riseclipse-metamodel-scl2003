...
public class IEDImpl extends UnNamingImpl implements IED {
    ...
    protected EClass eStaticClass() {
		return SclPackage.Literals.IED;
	}
    ...
    * <!-- end-user-doc -->
	...
	public boolean validateIED_originalSclVersion_valid(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		if (le) {
			...
			/*@Caught*/ /*@NonNull*/ Object CAUGHT_symbol_1;
			try {
				final /*@NonInvalid*/ String originalSclVersion = this.getOriginalSclVersion();
				final /*@NonInvalid*/ boolean ne = originalSclVersion != null;
				/*@Thrown*/ boolean status;
				if (ne) {
					final /*@Thrown*/ boolean validSclVersion = ((SclObject)this).validSclVersion(originalSclVersion);
				...
				if (status) {
					...
					final /*@NonInvalid*/ String sum_0 = StringConcatOperation.INSTANCE.evaluate(sum, SclTables.STR__e__32);
					final /*@NonInvalid*/ String sum_1 = StringConcatOperation.INSTANCE.evaluate(sum_0, SclTables.STR_Current_32_value_32_is_32);
					final /*@Thrown*/ String toString_0 = OclAnyToStringOperation.INSTANCE.evaluate(originalSclVersion);
					final /*@Thrown*/ String sum_2 = StringConcatOperation.INSTANCE.evaluate(sum_1, toString_0);
					final /*@Thrown*/ TupleValue symbol_0 = ValueUtil.createTupleOfEach(SclTables.TUPLid_, sum_2, status);
					symbol_1 = symbol_0;
				}
	...
	public boolean validateIED_originalSclRevision_valid(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		if (le) {
			...
			/*@Caught*/ /*@NonNull*/ Object CAUGHT_symbol_1;
			try {
				final /*@NonInvalid*/ String originalSclRevision_0 = this.getOriginalSclRevision();
				final /*@NonInvalid*/ boolean ne = originalSclRevision_0 != null;
				/*@Thrown*/ boolean status;
				if (ne) {
					final /*@Thrown*/ boolean validSclRevision = ((SclObject)this).validSclRevision(originalSclRevision_0);
				...
				if (status) {
					...
					final /*@NonInvalid*/ String sum_0 = StringConcatOperation.INSTANCE.evaluate(sum, SclTables.STR__e__32);
					final /*@NonInvalid*/ String sum_1 = StringConcatOperation.INSTANCE.evaluate(sum_0, SclTables.STR_Current_32_value_32_is_32);
					final /*@Thrown*/ String toString_0 = OclAnyToStringOperation.INSTANCE.evaluate(originalSclRevision_0);
					final /*@Thrown*/ String sum_2 = StringConcatOperation.INSTANCE.evaluate(sum_1, toString_0);
					final /*@Thrown*/ TupleValue symbol_0 = ValueUtil.createTupleOfEach(SclTables.TUPLid_, sum_2, status);
					symbol_1 = symbol_0;
				}
	...
	public boolean validateengRight_valid(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		if (le) {
			...
			/*@Caught*/ /*@NonNull*/ Object CAUGHT_symbol_1;
			try {
				final /*@NonInvalid*/ String engRight_0 = this.getEngRight();
				final /*@NonInvalid*/ boolean ne = engRight_0 != null;
				/*@Thrown*/ boolean status;
				if (ne) {
					final /*@Thrown*/ boolean validSclRightEnum = ((SclObject)this).validSclRightEnum(engRight_0);
				...
				if (status) {
					...
					final /*@NonInvalid*/ String sum_0 = StringConcatOperation.INSTANCE.evaluate(sum, SclTables.STR__e__32);
					final /*@NonInvalid*/ String sum_1 = StringConcatOperation.INSTANCE.evaluate(sum_0, SclTables.STR_Current_32_value_32_is_32);
					final /*@Thrown*/ String toString_0 = OclAnyToStringOperation.INSTANCE.evaluate(engRight_0);
					final /*@Thrown*/ String sum_2 = StringConcatOperation.INSTANCE.evaluate(sum_1, toString_0);
					final /*@Thrown*/ TupleValue symbol_0 = ValueUtil.createTupleOfEach(SclTables.TUPLid_, sum_2, status);
					symbol_1 = symbol_0;
				}
