 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.iec61850.scl.impl.GetDirectoryImpl#getServices <em>Services</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GetDirectoryImpl extends ServiceYesNoImpl implements GetDirectory {
    ...
    protected EClass eStaticClass() {
		return SclPackage.Literals.GET_DIRECTORY;
	}
    ...
    public NotificationChain basicSetServices( Services newServices, NotificationChain msgs ) {
		msgs = eBasicSetContainer((InternalEObject)newServices, SclPackage.GET_DIRECTORY__SERVICES, msgs);
		return msgs;
	}
    ...
    public void setServices( Services newServices ) {
		if (newServices != eInternalContainer() || (eContainerFeatureID() != SclPackage.GET_DIRECTORY__SERVICES && newServices != null)) {
			...
			if (newServices != null)
				msgs = ((InternalEObject)newServices).eInverseAdd(this, SclPackage.SERVICES__GET_DIRECTORY, Services.class, msgs);
			msgs = basicSetServices(newServices, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SclPackage.GET_DIRECTORY__SERVICES, newServices, newServices));
	}
    ...
    public NotificationChain eInverseAdd( InternalEObject otherEnd, int featureID, NotificationChain msgs ) {
		switch (featureID) {
			case SclPackage.GET_DIRECTORY__SERVICES:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
