...
public class EqFunctionImpl extends AbstractEqFuncSubFuncImpl implements EqFunction {
    ...
    /**
	 * The cached validation expression for the '{@link #validateEqFunction_nothing(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Eq Function nothing</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateEqFunction_nothing(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_EQ_FUNCTION_NOTHING_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION = "\n" +
		"        true\n" +
		"\n" +
		"\n" +
		"";
	 ...
	 * @generated
	 */
	public boolean validateEqFunction_nothing(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			SclValidator.validate
				(SclPackage.eINSTANCE.getEqFunction(),
				 this,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 SclPackage.eINSTANCE.getEqFunction__ValidateEqFunction_nothing__DiagnosticChain_Map(),
				 VALIDATE_EQ_FUNCTION_NOTHING_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION,
				 Diagnostic.ERROR,
				 SclValidator.DIAGNOSTIC_SOURCE,
				 SclValidator.EQ_FUNCTION__VALIDATE_EQ_FUNCTION_NOTHING);
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case SclPackage.EQ_FUNCTION___VALIDATE_EQ_FUNCTION_NOTHING__DIAGNOSTICCHAIN_MAP:
				return validateEqFunction_nothing((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
		}
