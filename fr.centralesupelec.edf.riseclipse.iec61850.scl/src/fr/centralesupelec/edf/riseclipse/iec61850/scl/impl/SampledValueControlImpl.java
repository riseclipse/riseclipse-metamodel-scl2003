...
public class SampledValueControlImpl extends ControlWithIEDNameImpl implements SampledValueControl {
    ...
    * <!-- end-user-doc -->
    ...
    /**
	 * The cached validation expression for the '{@link #validateSampledValueControl_smvID_required(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Sampled Value Control smv ID required</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateSampledValueControl_smvID_required(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_SAMPLED_VALUE_CONTROL_SMV_ID_REQUIRED_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION = "Tuple {\n" +
	 ...
	 * @generated
	 */
	public boolean validateSampledValueControl_smvID_required(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			SclValidator.validate
				(SclPackage.eINSTANCE.getSampledValueControl(),
				 this,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 SclPackage.eINSTANCE.getSampledValueControl__ValidateSampledValueControl_smvID_required__DiagnosticChain_Map(),
				 VALIDATE_SAMPLED_VALUE_CONTROL_SMV_ID_REQUIRED_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION,
				 Diagnostic.ERROR,
				 SclValidator.DIAGNOSTIC_SOURCE,
				 SclValidator.SAMPLED_VALUE_CONTROL__VALIDATE_SAMPLED_VALUE_CONTROL_SMV_ID_REQUIRED);
	}

				/**
	 * The cached validation expression for the '{@link #validateSampledValueControl_smvID_valid(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Sampled Value Control smv ID valid</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateSampledValueControl_smvID_valid(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_SAMPLED_VALUE_CONTROL_SMV_ID_VALID_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION = "Tuple {\n" +
		"\tmessage : String = 'smvID attribute shall be present in SampledValueControl (line ' + self.lineNumber.toString() + '). '\n" +
	 ...
	 * @generated
	 */
	public boolean validateSampledValueControl_smvID_valid(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			SclValidator.validate
				(SclPackage.eINSTANCE.getSampledValueControl(),
				 this,
				 ...
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 SclPackage.eINSTANCE.getSampledValueControl__ValidateSampledValueControl_smvID_valid__DiagnosticChain_Map(),
				 VALIDATE_SAMPLED_VALUE_CONTROL_SMV_ID_VALID_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION,
				 Diagnostic.ERROR,
				 SclValidator.DIAGNOSTIC_SOURCE,
				 SclValidator.SAMPLED_VALUE_CONTROL__VALIDATE_SAMPLED_VALUE_CONTROL_SMV_ID_VALID);
	}

				/**
	 * The cached validation expression for the '{@link #validateSampledValueControl_smpRate_required(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Sampled Value Control smp Rate required</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateSampledValueControl_smpRate_required(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_SAMPLED_VALUE_CONTROL_SMP_RATE_REQUIRED_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION = "Tuple {\n" +
	 ...
	 * @generated
	 */
	public boolean validateSampledValueControl_smpRate_required(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			SclValidator.validate
				(SclPackage.eINSTANCE.getSampledValueControl(),
				 this,
				 ...
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 SclPackage.eINSTANCE.getSampledValueControl__ValidateSampledValueControl_smpRate_required__DiagnosticChain_Map(),
				 VALIDATE_SAMPLED_VALUE_CONTROL_SMP_RATE_REQUIRED_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION,
				 Diagnostic.ERROR,
				 SclValidator.DIAGNOSTIC_SOURCE,
				 SclValidator.SAMPLED_VALUE_CONTROL__VALIDATE_SAMPLED_VALUE_CONTROL_SMP_RATE_REQUIRED);
	}

				/**
	 * The cached validation expression for the '{@link #validateSampledValueControl_smpRate_valid(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Sampled Value Control smp Rate valid</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateSampledValueControl_smpRate_valid(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_SAMPLED_VALUE_CONTROL_SMP_RATE_VALID_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION = "Tuple {\n" +
	 ...
	 * @generated
	 */
	public boolean validateSampledValueControl_smpRate_valid(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			SclValidator.validate
				(SclPackage.eINSTANCE.getSampledValueControl(),
				 this,
				 ...
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 SclPackage.eINSTANCE.getSampledValueControl__ValidateSampledValueControl_smpRate_valid__DiagnosticChain_Map(),
				 VALIDATE_SAMPLED_VALUE_CONTROL_SMP_RATE_VALID_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION,
				 Diagnostic.ERROR,
				 SclValidator.DIAGNOSTIC_SOURCE,
				 SclValidator.SAMPLED_VALUE_CONTROL__VALIDATE_SAMPLED_VALUE_CONTROL_SMP_RATE_VALID);
	}

				/**
	 * The cached validation expression for the '{@link #validateSampledValueControl_nofASDU_required(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Sampled Value Control nof ASDU required</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateSampledValueControl_nofASDU_required(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_SAMPLED_VALUE_CONTROL_NOF_ASDU_REQUIRED_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION = "Tuple {\n" +
	 ...
	 * @generated
	 */
	public boolean validateSampledValueControl_nofASDU_required(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			SclValidator.validate
				(SclPackage.eINSTANCE.getSampledValueControl(),
				 this,
				 ...
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 SclPackage.eINSTANCE.getSampledValueControl__ValidateSampledValueControl_nofASDU_required__DiagnosticChain_Map(),
				 VALIDATE_SAMPLED_VALUE_CONTROL_NOF_ASDU_REQUIRED_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION,
				 Diagnostic.ERROR,
				 SclValidator.DIAGNOSTIC_SOURCE,
				 SclValidator.SAMPLED_VALUE_CONTROL__VALIDATE_SAMPLED_VALUE_CONTROL_NOF_ASDU_REQUIRED);
	}

				/**
	 * The cached validation expression for the '{@link #validateSampledValueControl_nofASDU_valid(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Sampled Value Control nof ASDU valid</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateSampledValueControl_nofASDU_valid(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_SAMPLED_VALUE_CONTROL_NOF_ASDU_VALID_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION = "Tuple {\n" +
		"\tmessage : String = 'nofASDU attribute shall be present in SampledValueControl (line ' + self.lineNumber.toString() + '). '\n" +
	 ...
	 * @generated
	 */
	public boolean validateSampledValueControl_nofASDU_valid(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			SclValidator.validate
				(SclPackage.eINSTANCE.getSampledValueControl(),
				 this,
				 ...
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 SclPackage.eINSTANCE.getSampledValueControl__ValidateSampledValueControl_nofASDU_valid__DiagnosticChain_Map(),
				 VALIDATE_SAMPLED_VALUE_CONTROL_NOF_ASDU_VALID_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION,
				 Diagnostic.ERROR,
				 SclValidator.DIAGNOSTIC_SOURCE,
				 SclValidator.SAMPLED_VALUE_CONTROL__VALIDATE_SAMPLED_VALUE_CONTROL_NOF_ASDU_VALID);
	}

				/**
	 * The cached validation expression for the '{@link #validateSampledValueControl_confRev_required(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Sampled Value Control conf Rev required</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateSampledValueControl_confRev_required(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_SAMPLED_VALUE_CONTROL_CONF_REV_REQUIRED_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION = "Tuple {\n" +
	 ...
	 * @generated
	 */
	public boolean validateSampledValueControl_confRev_required(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			SclValidator.validate
				(SclPackage.eINSTANCE.getSampledValueControl(),
				 this,
				 ...
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 SclPackage.eINSTANCE.getSampledValueControl__ValidateSampledValueControl_confRev_required__DiagnosticChain_Map(),
				 VALIDATE_SAMPLED_VALUE_CONTROL_CONF_REV_REQUIRED_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION,
				 Diagnostic.ERROR,
				 SclValidator.DIAGNOSTIC_SOURCE,
				 SclValidator.SAMPLED_VALUE_CONTROL__VALIDATE_SAMPLED_VALUE_CONTROL_CONF_REV_REQUIRED);
	}

				/**
	 * The cached validation expression for the '{@link #validateSampledValueControl_confRev_unsignedInt(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Sampled Value Control conf Rev unsigned Int</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateSampledValueControl_confRev_unsignedInt(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_SAMPLED_VALUE_CONTROL_CONF_REV_UNSIGNED_INT_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION = "Tuple {\n" +
	 ...
	 * @generated
	 */
	public boolean validateSampledValueControl_confRev_unsignedInt(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			SclValidator.validate
				(SclPackage.eINSTANCE.getSampledValueControl(),
				 this,
				 ...
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 SclPackage.eINSTANCE.getSampledValueControl__ValidateSampledValueControl_confRev_unsignedInt__DiagnosticChain_Map(),
				 VALIDATE_SAMPLED_VALUE_CONTROL_CONF_REV_UNSIGNED_INT_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION,
				 Diagnostic.ERROR,
				 SclValidator.DIAGNOSTIC_SOURCE,
				 SclValidator.SAMPLED_VALUE_CONTROL__VALIDATE_SAMPLED_VALUE_CONTROL_CONF_REV_UNSIGNED_INT);
	}

				/**
	 * The cached validation expression for the '{@link #validateSampledValueControl_one_SmvOpts_required(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Sampled Value Control one Smv Opts required</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateSampledValueControl_one_SmvOpts_required(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_SAMPLED_VALUE_CONTROL_ONE_SMV_OPTS_REQUIRED_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION = "Tuple {\n" +
	 ...
	 * @generated
	 */
	public boolean validateSampledValueControl_one_SmvOpts_required(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			SclValidator.validate
				(SclPackage.eINSTANCE.getSampledValueControl(),
				 this,
				 ...
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 SclPackage.eINSTANCE.getSampledValueControl__ValidateSampledValueControl_one_SmvOpts_required__DiagnosticChain_Map(),
				 VALIDATE_SAMPLED_VALUE_CONTROL_ONE_SMV_OPTS_REQUIRED_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION,
				 Diagnostic.ERROR,
				 SclValidator.DIAGNOSTIC_SOURCE,
				 SclValidator.SAMPLED_VALUE_CONTROL__VALIDATE_SAMPLED_VALUE_CONTROL_ONE_SMV_OPTS_REQUIRED);
	}

				/**
	 * The cached validation expression for the '{@link #validateSampledValueControl_multicast(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Sampled Value Control multicast</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateSampledValueControl_multicast(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_SAMPLED_VALUE_CONTROL_MULTICAST_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION = "Tuple {\n" +
	 ...
	 * @generated
	 */
	public boolean validateSampledValueControl_multicast(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			SclValidator.validate
				(SclPackage.eINSTANCE.getSampledValueControl(),
				 this,
				 ...
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 SclPackage.eINSTANCE.getSampledValueControl__ValidateSampledValueControl_multicast__DiagnosticChain_Map(),
				 VALIDATE_SAMPLED_VALUE_CONTROL_MULTICAST_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION,
				 Diagnostic.ERROR,
				 SclValidator.DIAGNOSTIC_SOURCE,
				 SclValidator.SAMPLED_VALUE_CONTROL__VALIDATE_SAMPLED_VALUE_CONTROL_MULTICAST);
	}
