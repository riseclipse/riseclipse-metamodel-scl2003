...
public class ServiceWithOptionalMaxImpl extends SclObjectImpl implements ServiceWithOptionalMax {
    ...
    protected EClass eStaticClass() {
		return SclPackage.Literals.SERVICE_WITH_OPTIONAL_MAX;
	}
	 ...
	 * @generated
	 */
	public boolean validateServiceWithOptionalMax_max_valid(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		/**
		 *
		...
		final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, SclTables.STR_ServiceWithOptionalMax_c_c_ServiceWithOptionalMax_max_valid);
		...
		if (le) {
			...
			try {
				...
				if (status) {
					...
					final /*@NonInvalid*/ String sum = StringConcatOperation.INSTANCE.evaluate(SclTables.STR_max_32_attribute_32_shall_32_be_32_valid_32_in_32_ServiceWithOptionalMax_32_o_line_32, toString);
			...
			final /*@NonInvalid*/ boolean logDiagnostic = CGStringLogDiagnosticOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, SclTables.STR_ServiceWithOptionalMax_c_c_ServiceWithOptionalMax_max_valid, this, (Object)null, diagnostics, context, (Object)null, severity_0, CAUGHT_symbol_1, SclTables.INT_0).booleanValue();
