 ...
 * @generated
 */
public class ApplicationItemProvider extends BaseExtensionElementWithDescItemProvider {
    /**
    ...
    protected void addNamePropertyDescriptor( Object object ) {
        itemPropertyDescriptors.add(
                createItemPropertyDescriptor( ( ( ComposeableAdapterFactory ) adapterFactory ).getRootAdapterFactory(),
                        ...
                        AsdPackage.eINSTANCE.getApplication_Name(),
                        true,
                        false,
                        false,
    ...
    protected void addTypePropertyDescriptor( Object object ) {
        itemPropertyDescriptors.add(
                createItemPropertyDescriptor( ( ( ComposeableAdapterFactory ) adapterFactory ).getRootAdapterFactory(),
                        getResourceLocator(),
                        getString( "_UI_Application_type_feature" ),
                        getString( "_UI_PropertyDescriptor_description", "_UI_Application_type_feature",
                                "_UI_Application_type" ),
                        AsdPackage.eINSTANCE.getApplication_Type(),
                        true,
                        false,
                        false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    public Collection< ? extends EStructuralFeature > getChildrenFeatures( Object object ) {
        if( childrenFeatures == null ) {
            ...
            childrenFeatures.add( AsdPackage.eINSTANCE.getApplication_FunctionRole() );
            childrenFeatures.add( AsdPackage.eINSTANCE.getApplication_FunctionalVariant() );
            childrenFeatures.add( AsdPackage.eINSTANCE.getApplication_FunctionalVariantGroup() );
            childrenFeatures.add( AsdPackage.eINSTANCE.getApplication_AllocationRoleRef() );
            childrenFeatures.add( AsdPackage.eINSTANCE.getApplication_ApplicationSclRef() );
        }
    ...
    protected void collectNewChildDescriptors( Collection< Object > newChildDescriptors, Object object ) {
        ...
        newChildDescriptors.add( createChildParameter( AsdPackage.eINSTANCE.getApplication_FunctionRole(),
                AsdFactory.eINSTANCE.createFunctionRole() ) );

        newChildDescriptors.add( createChildParameter( AsdPackage.eINSTANCE.getApplication_FunctionalVariant(),
                AsdFactory.eINSTANCE.createFunctionalVariant() ) );

        newChildDescriptors.add( createChildParameter( AsdPackage.eINSTANCE.getApplication_FunctionalVariantGroup(),
                AsdFactory.eINSTANCE.createFunctionalVariantGroup() ) );

        newChildDescriptors.add( createChildParameter( AsdPackage.eINSTANCE.getApplication_AllocationRoleRef(),
                AsdFactory.eINSTANCE.createAllocationRoleRef() ) );

        newChildDescriptors.add( createChildParameter( AsdPackage.eINSTANCE.getApplication_ApplicationSclRef(),
