 ...
 * @generated
 */
public class FunctionCategoryItemProvider extends BaseExtensionElementWithDescItemProvider {
    /**
     ...
     * @generated
     */
    public FunctionCategoryItemProvider( AdapterFactory adapterFactory ) {
    ...
    protected void addNamePropertyDescriptor( Object object ) {
        itemPropertyDescriptors.add(
                createItemPropertyDescriptor( ( ( ComposeableAdapterFactory ) adapterFactory ).getRootAdapterFactory(),
                        getResourceLocator(),
                        getString( "_UI_FunctionCategory_name_feature" ),
                        getString( "_UI_PropertyDescriptor_description", "_UI_FunctionCategory_name_feature",
                                "_UI_FunctionCategory_type" ),
                        AsdPackage.eINSTANCE.getFunctionCategory_Name(),
                        true,
                        false,
                        false,
    ...
    /**
     * This adds a property descriptor for the Referred By Function Category Ref feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    protected void addReferredByFunctionCategoryRefPropertyDescriptor( Object object ) {
        itemPropertyDescriptors.add( createItemPropertyDescriptor(
                ( ( ComposeableAdapterFactory ) adapterFactory ).getRootAdapterFactory(),
                getResourceLocator(),
                getString( "_UI_FunctionCategory_ReferredByFunctionCategoryRef_feature" ),
                getString( "_UI_PropertyDescriptor_description",
                        "_UI_FunctionCategory_ReferredByFunctionCategoryRef_feature", "_UI_FunctionCategory_type" ),
                AsdPackage.eINSTANCE.getFunctionCategory_ReferredByFunctionCategoryRef(),
                true,
                false,
                true,
                null,
    ...
    public Collection< ? extends EStructuralFeature > getChildrenFeatures( Object object ) {
        if( childrenFeatures == null ) {
            ...
            childrenFeatures.add( AsdPackage.eINSTANCE.getFunctionCategory_SubCategory() );
            childrenFeatures.add( AsdPackage.eINSTANCE.getFunctionCategory_FunctionCatRef() );
        }
    ...
    /**
     * This returns FunctionCategory.gif.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    public Object getImage( Object object ) {
        return overlayImage( object, getResourceLocator().getImage( "full/obj16/FunctionCategory" ) );
    }
    ...
    public String getText( Object object ) {
        String label = ( ( FunctionCategory ) object ).getName();
        return label == null || label.length() == 0 ? getString( "_UI_FunctionCategory_type" )
                : getString( "_UI_FunctionCategory_type" ) + " " + label;
    }
    ...
    protected void collectNewChildDescriptors( Collection< Object > newChildDescriptors, Object object ) {
        ...
        newChildDescriptors.add( createChildParameter( AsdPackage.eINSTANCE.getFunctionCategory_SubCategory(),
                AsdFactory.eINSTANCE.createSubCategory() ) );

        newChildDescriptors.add( createChildParameter( AsdPackage.eINSTANCE.getFunctionCategory_FunctionCatRef(),
