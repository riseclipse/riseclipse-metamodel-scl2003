 ...
 * @generated
 */
public class FunctionalVariantGroupItemProvider extends BaseExtensionElementWithDescItemProvider {
    /**
     ...
     * @generated
     */
    public FunctionalVariantGroupItemProvider( AdapterFactory adapterFactory ) {
    ...
    protected void addNamePropertyDescriptor( Object object ) {
        itemPropertyDescriptors.add(
                createItemPropertyDescriptor( ( ( ComposeableAdapterFactory ) adapterFactory ).getRootAdapterFactory(),
                        getResourceLocator(),
                        getString( "_UI_FunctionalVariantGroup_name_feature" ),
                        getString( "_UI_PropertyDescriptor_description", "_UI_FunctionalVariantGroup_name_feature",
                                "_UI_FunctionalVariantGroup_type" ),
                        AsdPackage.eINSTANCE.getFunctionalVariantGroup_Name(),
                        true,
                        false,
                        false,
    ...
    public Collection< ? extends EStructuralFeature > getChildrenFeatures( Object object ) {
        if( childrenFeatures == null ) {
            ...
            childrenFeatures.add( AsdPackage.eINSTANCE.getFunctionalVariantGroup_FunctionalVariant() );
        }
    ...
    /**
     * This returns FunctionalVariantGroup.gif.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    public Object getImage( Object object ) {
        return overlayImage( object, getResourceLocator().getImage( "full/obj16/FunctionalVariantGroup" ) );
    }
    ...
    public String getText( Object object ) {
        String label = ( ( FunctionalVariantGroup ) object ).getName();
        return label == null || label.length() == 0 ? getString( "_UI_FunctionalVariantGroup_type" )
                : getString( "_UI_FunctionalVariantGroup_type" ) + " " + label;
    }
    ...
    protected void collectNewChildDescriptors( Collection< Object > newChildDescriptors, Object object ) {
        ...
        newChildDescriptors
                .add( createChildParameter( AsdPackage.eINSTANCE.getFunctionalVariantGroup_FunctionalVariant(),
