 ...
 * @generated
 */
public class AbstractFunctionalVariantItemProvider extends BaseExtensionElementWithDescItemProvider {
    /**
     ...
     * @generated
     */
    public AbstractFunctionalVariantItemProvider( AdapterFactory adapterFactory ) {
    ...
    /**
     * This adds a property descriptor for the Is Baseline feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    protected void addIsBaselinePropertyDescriptor( Object object ) {
        itemPropertyDescriptors.add( createItemPropertyDescriptor(
                ( ( ComposeableAdapterFactory ) adapterFactory ).getRootAdapterFactory(),
                getResourceLocator(),
                getString( "_UI_AbstractFunctionalVariant_isBaseline_feature" ),
                getString( "_UI_PropertyDescriptor_description", "_UI_AbstractFunctionalVariant_isBaseline_feature",
                        "_UI_AbstractFunctionalVariant_type" ),
                AsdPackage.eINSTANCE.getAbstractFunctionalVariant_IsBaseline(),
                true,
                false,
                false,
    ...
    protected void addNamePropertyDescriptor( Object object ) {
        itemPropertyDescriptors.add(
                createItemPropertyDescriptor( ( ( ComposeableAdapterFactory ) adapterFactory ).getRootAdapterFactory(),
                        getResourceLocator(),
                        getString( "_UI_AbstractFunctionalVariant_name_feature" ),
                        getString( "_UI_PropertyDescriptor_description", "_UI_AbstractFunctionalVariant_name_feature",
                                "_UI_AbstractFunctionalVariant_type" ),
                        AsdPackage.eINSTANCE.getAbstractFunctionalVariant_Name(),
                        true,
                        false,
                        false,
    ...
    public Collection< ? extends EStructuralFeature > getChildrenFeatures( Object object ) {
        if( childrenFeatures == null ) {
            ...
            childrenFeatures.add( AsdPackage.eINSTANCE.getAbstractFunctionalVariant_FunctionalSubVariant() );
            childrenFeatures.add( AsdPackage.eINSTANCE.getAbstractFunctionalVariant_VariableRef() );
        }
    ...
    public String getText( Object object ) {
        String label = ( ( AbstractFunctionalVariant ) object ).getName();
        return label == null || label.length() == 0 ? getString( "_UI_AbstractFunctionalVariant_type" )
                : getString( "_UI_AbstractFunctionalVariant_type" ) + " " + label;
    }
    ...
    protected void collectNewChildDescriptors( Collection< Object > newChildDescriptors, Object object ) {
        ...
        newChildDescriptors
                .add( createChildParameter( AsdPackage.eINSTANCE.getAbstractFunctionalVariant_FunctionalSubVariant(),
                        AsdFactory.eINSTANCE.createFunctionalSubVariant() ) );

        newChildDescriptors.add( createChildParameter( AsdPackage.eINSTANCE.getAbstractFunctionalVariant_VariableRef(),
