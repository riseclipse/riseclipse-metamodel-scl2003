 ...
 * @generated
 */
public class AllocationRoleItemProvider extends BaseExtensionElementWithDescItemProvider {
    /**
    ...
    protected void addNamePropertyDescriptor( Object object ) {
        itemPropertyDescriptors.add(
                createItemPropertyDescriptor( ( ( ComposeableAdapterFactory ) adapterFactory ).getRootAdapterFactory(),
                        getResourceLocator(),
                        getString( "_UI_AllocationRole_name_feature" ),
                        getString( "_UI_PropertyDescriptor_description", "_UI_AllocationRole_name_feature",
                                "_UI_AllocationRole_type" ),
                        AsdPackage.eINSTANCE.getAllocationRole_Name(),
                        true,
                        false,
                        false,
    ...
    /**
     * This adds a property descriptor for the Referred By Allocation Role Ref feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    protected void addReferredByAllocationRoleRefPropertyDescriptor( Object object ) {
        itemPropertyDescriptors.add(
                createItemPropertyDescriptor( ( ( ComposeableAdapterFactory ) adapterFactory ).getRootAdapterFactory(),
                        getResourceLocator(),
                        getString( "_UI_AllocationRole_ReferredByAllocationRoleRef_feature" ),
                        getString( "_UI_PropertyDescriptor_description",
                                "_UI_AllocationRole_ReferredByAllocationRoleRef_feature", "_UI_AllocationRole_type" ),
                        AsdPackage.eINSTANCE.getAllocationRole_ReferredByAllocationRoleRef(),
                        true,
                        false,
                        true,
                        null,
    ...
    public Collection< ? extends EStructuralFeature > getChildrenFeatures( Object object ) {
        if( childrenFeatures == null ) {
            ...
            childrenFeatures.add( AsdPackage.eINSTANCE.getAllocationRole_FunctionRef() );
        }
    ...
    public String getText( Object object ) {
        String label = ( ( AllocationRole ) object ).getName();
        return label == null || label.length() == 0 ? getString( "_UI_AllocationRole_type" )
    ...
    protected void collectNewChildDescriptors( Collection< Object > newChildDescriptors, Object object ) {
        ...
        newChildDescriptors.add( createChildParameter( AsdPackage.eINSTANCE.getAllocationRole_FunctionRef(),
