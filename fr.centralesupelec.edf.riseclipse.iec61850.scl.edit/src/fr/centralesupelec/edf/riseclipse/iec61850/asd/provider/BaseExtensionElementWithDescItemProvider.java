...
public class BaseExtensionElementWithDescItemProvider extends BaseExtensionElementItemProvider {
    ...
    protected void addDescPropertyDescriptor( Object object ) {
        itemPropertyDescriptors.add( createItemPropertyDescriptor(
                ...
                getResourceLocator(),
                getString( "_UI_BaseExtensionElementWithDesc_desc_feature" ),
                getString( "_UI_PropertyDescriptor_description", "_UI_BaseExtensionElementWithDesc_desc_feature",
                        "_UI_BaseExtensionElementWithDesc_type" ),
                AsdPackage.eINSTANCE.getBaseExtensionElementWithDesc_Desc(),
                true,
                false,
                false,
