 ...
 * @generated
 */
public class BaseExtensionElementItemProvider extends AsdObjectItemProvider {
    /**
     ...
     * @generated
     */
    public BaseExtensionElementItemProvider( AdapterFactory adapterFactory ) {
    ...
    public String getText( Object object ) {
        String label = ( ( BaseExtensionElement ) object ).getFilename();
        return label == null || label.length() == 0 ? getString( "_UI_BaseExtensionElement_type" )
                : getString( "_UI_BaseExtensionElement_type" ) + " " + label;
    }
    ...
    protected void collectNewChildDescriptors( Collection< Object > newChildDescriptors, Object object ) {
        ...
        newChildDescriptors.add( createChildParameter( AsdPackage.eINSTANCE.getBaseExtensionElement_Text(),
