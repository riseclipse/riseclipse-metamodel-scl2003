...
/**
 * This is the item provider adapter for a {@link fr.centralesupelec.edf.riseclipse.iec61850.scl.GOOSE} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GOOSEItemProvider extends ServiceWithMaxItemProvider {
    /**
     ...
     * @generated
     */
    public GOOSEItemProvider( AdapterFactory adapterFactory ) {
    ...
    protected void addFixedOffsPropertyDescriptor( Object object ) {
        itemPropertyDescriptors.add(
                createItemPropertyDescriptor( ( ( ComposeableAdapterFactory ) adapterFactory ).getRootAdapterFactory(),
                        ...
                        getString( "_UI_PropertyDescriptor_description", "_UI_GOOSE_fixedOffs_feature",
                                "_UI_GOOSE_type" ),
    ...
    public Object getImage( Object object ) {
        return overlayImage( object, getResourceLocator().getImage( "full/obj16/GOOSE" ) );
    }
    ...
    public String getText( Object object ) {
        String label = ( ( GOOSE ) object ).getFilename();
        return label == null || label.length() == 0 ? getString( "_UI_GOOSE_type" )
                : getString( "_UI_GOOSE_type" ) + " " + label;
    }
