...
public class SclItemProviderAdapterFactory extends SclAdapterFactory
    ...
    /**
     * This keeps track of the one adapter used for all {@link fr.centralesupelec.edf.riseclipse.iec61850.scl.SclFileUUIDReference} instances.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    protected SclFileUUIDReferenceItemProvider sclFileUUIDReferenceItemProvider;

    /**
     * This creates an adapter for a {@link fr.centralesupelec.edf.riseclipse.iec61850.scl.SclFileUUIDReference}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    public Adapter createSclFileUUIDReferenceAdapter() {
        if( sclFileUUIDReferenceItemProvider == null ) {
            sclFileUUIDReferenceItemProvider = new SclFileUUIDReferenceItemProvider( this );
        }

        return sclFileUUIDReferenceItemProvider;
    }
    ...
    /**
     * This keeps track of the one adapter used for all {@link fr.centralesupelec.edf.riseclipse.iec61850.scl.IEDSclRef} instances.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    protected IEDSclRefItemProvider iedSclRefItemProvider;

    /**
     * This creates an adapter for a {@link fr.centralesupelec.edf.riseclipse.iec61850.scl.IEDSclRef}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    public Adapter createIEDSclRefAdapter() {
        if( iedSclRefItemProvider == null ) {
            iedSclRefItemProvider = new IEDSclRefItemProvider( this );
        }

        return iedSclRefItemProvider;
    }
    ...
    /**
     * This keeps track of the one adapter used for all {@link fr.centralesupelec.edf.riseclipse.iec61850.scl.HeaderSclRef} instances.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    protected HeaderSclRefItemProvider headerSclRefItemProvider;

    /**
     * This creates an adapter for a {@link fr.centralesupelec.edf.riseclipse.iec61850.scl.HeaderSclRef}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    public Adapter createHeaderSclRefAdapter() {
        if( headerSclRefItemProvider == null ) {
            headerSclRefItemProvider = new HeaderSclRefItemProvider( this );
        }

        return headerSclRefItemProvider;
    }
    ...
    public void dispose() {
        ...
        if( sclFileUUIDReferenceItemProvider != null ) {
            sclFileUUIDReferenceItemProvider.dispose();
        }
        if( securityItemProvider != null ) {
        ...
        if( headerSclRefItemProvider != null ) {
            headerSclRefItemProvider.dispose();
        }
        if( certItemProvider != null ) {
