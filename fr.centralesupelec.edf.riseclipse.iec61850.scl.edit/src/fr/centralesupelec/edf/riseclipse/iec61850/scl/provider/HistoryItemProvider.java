...
/**
 * This is the item provider adapter for a {@link fr.centralesupelec.edf.riseclipse.iec61850.scl.History} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HistoryItemProvider
    ...
    public Collection< ? extends EStructuralFeature > getChildrenFeatures( Object object ) {
        if( childrenFeatures == null ) {
            ...
            childrenFeatures.add( SclPackage.eINSTANCE.getHistory_Hitem() );
        }
    ...
    public String getText( Object object ) {
        String label = ( ( History ) object ).getFilename();
        return label == null || label.length() == 0 ? getString( "_UI_History_type" )
    ...
    protected void collectNewChildDescriptors( Collection< Object > newChildDescriptors, Object object ) {
        ...
        newChildDescriptors.add( createChildParameter( SclPackage.eINSTANCE.getHistory_Hitem(),
                SclFactory.eINSTANCE.createHitem() ) );
    }
